...
export const Header = () => {
    return (
        <header className="h-16 grid grid-cols-1 items-center md:h-20 lg:h-24">
            <div className="container flex items-center justify-between lg:grid lg:grid-cols-[2fr_1fr_2fr]">
                <Logo variant="icon" />
                                    ...
                                    <>
                                        ...
                                        <NavigationMenuContent>
                                            <ul className="grid grid-cols-2 gap-2 p-2 w-[640px]">
                                                {submenu.map(({ href, label, desc, icon }, index) => (
                                                    <li key={index}>
                ...
                <Popover>
                    ...
                    <PopoverContent
                        align="end"
                        className="bg-background/50 backdrop-blur-3xl border-foreground/5
